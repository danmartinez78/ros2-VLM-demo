...
def generate_comparison(
    ...
    comparison: dict[str, Any] = {
        ...
        "metadata": {
            ...
            "engine_profile_id": meta.get("engine_profile_id", ""),
            "quantization": meta.get("quantization", ""),
            "llm_engine_dir": meta.get("llm_engine_dir"),
            "multimodal_engine_dir": meta.get("multimodal_engine_dir"),
            "engine_manifest_path": meta.get("engine_manifest_path"),
            "engine_manifest_sha256": meta.get("engine_manifest_sha256"),
            "engine_identity": meta.get("engine_identity"),
            "engine_provenance": meta.get("engine_provenance"),
...
def format_text_report(comparison: dict[str, Any]) -> str:
    ...
    lines: list[str] = [
        ...
        f"  Profile:      {meta.get('engine_profile_id', 'n/a')}",
        f"  Quantization: {meta.get('quantization', 'n/a')}",
        f"  Engine identity: {meta.get('engine_identity', 'n/a')}",
        f"  LLM dir:      {meta.get('llm_engine_dir', 'n/a')}",
        f"  MM dir:       {meta.get('multimodal_engine_dir', 'n/a')}",
