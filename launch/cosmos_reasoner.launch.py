...
def generate_launch_description() -> LaunchDescription:
    ...
    args = [
        ...
        DeclareLaunchArgument(
            ...
            default_value='0',
            description='Count of prior successful responses retained for observation-history injection',
        ),
        DeclareLaunchArgument(
            'observation_history_max_chars',
            default_value='0',
            description='Maximum total retained observation-history characters (0 disables size limit)',
        ),
        DeclareLaunchArgument(
            'observation_history_reset_policy',
            default_value='never',
            description='Observation-history reset policy: never, on_error, every_n_requests',
        ),
        DeclareLaunchArgument(
    ...
    cosmos_node = Node(
        ...
        parameters=[
            default_config,
            {
                ...
                'observation_history_max_entries': LaunchConfiguration('observation_history_max_entries'),
                'observation_history_max_chars': LaunchConfiguration('observation_history_max_chars'),
